...
def run_genius(cur,conn):
    ...
    genius.calculation(cur, conn)
    genius.write_to_csv_new_file_1(artist_id_word_counts)
    artist_id_word_counts = artist_id_word_counts()
    #genius.list_of_tuples(item, cur, conn)
